...
public class Shipping {
    ...
    public Shipping(Integer id, Integer userId, String receiveName, String receiveMobile, String receivePhone, String receiveProvince, String receiveCity, String receiveDistrict, String receiveAddress, String receiveZip, Date createTime, Date updateTime) {
        this.id = id;
        this.userId = userId;
